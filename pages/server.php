...
while ($server = $result->fetch_assoc()) {
    if (isset($_POST['restart'])) {
        ...
        $session = establishSSH($server['ip'], $server['sshport'], translateID($server['sshuser'], 'users', 'username'), strdCrypt(translateID($server['sshuser'], 'users', 'password')));
    ...
    if (isset($_POST['delete'])) {
        ...
        $stmt->execute();
        die("<div class='alert alert-success'>Server deleted!</div>");
    }
